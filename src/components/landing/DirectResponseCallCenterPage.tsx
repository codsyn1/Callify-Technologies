...
const servicePillars = [
  {
    ...
    body: "Technicians with strong communication skills who resolve issues and represent your brand on every touch.",
    icon: UsersIcon,
  },
  {
    title: "Call overflow management",
    body: "Handle spikes without missed calls—protect response rates and keep overhead under control.",
    icon: ChartIcon,
  },
  {
    title: "Direct response advertising",
    body: "Maximum exposure to your target market with campaigns built for measurable inbound response.",
    icon: CheckIcon,
  },
  {
    title: "Marketing campaigns",
    body: "Launch support so direct response programs hit the ground running with governed scripts and QA.",
    icon: ClipboardIcon,
  },
  {
    title: "CDR cleanup & analysis",
    body: "Reconcile call detail records and produce reports your leadership can act on—not shelfware.",
    icon: HeartIcon,
  },
  {
    title: "Live chat automation",
    body: "Faster responses, shorter waits, and lower cost per lead alongside voice coverage.",
    icon: ClockIcon,
  },
];
...
const testimonials = [
  {
    quote:
      "Best customer service I have experienced—knowledgeable, on time, and thorough. Callify goes above and beyond on every campaign detail.",
    name: "Simona Long",
    role: "Marketing director, e-commerce",
  },
  {
    quote:
      "They listened, built a personalized direct response plan, and executed with strong follow-up. Results exceeded what we expected.",
    name: "Sigmund Ford",
    role: "Founder, DTC brand",
  },
  {
    quote:
      "Sales up 300% with clear updates and promises kept on contact times. They knew what worked and scaled it responsibly.",
    name: "Kevin Mathews",
    role: "Owner, regional retailer",
  },
];

const faqs = [
  {
    q: "How does Callify’s direct response call center work?",
    a: "We handle callers responding to your ads—inbound direct response and campaign support with scripts, QA, and reporting aligned to your offer.",
  },
  {
    q: "How much does direct response call center service cost?",
    a: "Pricing depends on agent count, services, and contract length. Starter packages are available before you commit long term.",
  },
  {
    q: "What are the benefits of this service?",
    a: "Lower cost versus many ad channels, stronger brand awareness, and an easy path for customers to connect when intent is highest.",
  },
  {
    q: "What kinds of clients do you work with?",
    a: "From solo-founder startups to enterprise programs—every business model gets a configuration that matches volume and compliance needs.",
  },
];
...
export function DirectResponseCallCenterPage() {
  ...
  return (
    <>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-14 lg:grid-cols-2 lg:gap-14 lg:py-20">
          <div className="min-w-0">
            ...
            <h1 className="mt-5 text-3xl font-bold tracking-tight text-foreground sm:text-4xl lg:text-[2.35rem] lg:leading-[1.12]">
              Leader in direct response call center services
            </h1>
            <p className="mt-5 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
              Leads handled with accuracy and compliance—Callify runs inbound direct
              response so campaigns convert without hold-music chaos.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-lg lg:mx-0 lg:max-w-none">
            ...
            <figure className="relative aspect-[5/4] overflow-hidden rounded-3xl border border-white/60 bg-white shadow-[0_28px_60px_-28px_rgba(65,116,185,0.35)] ring-1 ring-primary/10 sm:aspect-[4/3]">
              <Image
                src={HERO_IMAGE}
                alt="Direct response call center team at work"
                fill
                priority
      ...
      <section className="border-b border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
            Professional direct response call center service
          </h2>
          ...
          <p className="mt-6 text-base font-medium italic text-primary sm:text-lg">
            Ready to take your direct response campaign to the next level?
          </p>
          <p className="mt-6 text-base leading-relaxed text-muted sm:text-lg">
            One-stop inbound support—no endless transfers. Seasoned professionals
            strategize and run each campaign with the experience your brand deserves.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            Custom strategy to stand out, drive traffic, and increase conversions—
            while saving time and money versus building a floor from scratch.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            Marketers, sales trainers, and operators work as one team—because your
            direct response results should impress you as much as they impress us.
          </p>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-b from-surface via-white to-surface py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4">
          <div className="max-w-2xl">
            <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
              Why choose our direct response call center
            </h2>
            <div className="mt-3 h-1 w-12 rounded-full bg-primary" aria-hidden />
            <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
              De-stress your operations—we provide the hands-on coverage to make
              campaigns work while you focus on growth.
            </p>
          </div>
      ...
      <section className="border-y border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4">
          <h2 className="text-center text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
            What clients say about our direct response service
          </h2>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-14 lg:items-start">
            <div className="lg:col-span-7">
              <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
                Tell us about your direct response campaign
              </h2>
              <div className="mt-3 h-1 w-12 rounded-full bg-primary" aria-hidden />
              ...
              <div className="lg:sticky lg:top-28">
                <div className="overflow-hidden rounded-3xl border border-border/90 bg-white shadow-[0_20px_50px_-24px_rgba(15,23,42,0.15)] ring-1 ring-black/[0.04]">
                  ...
                  <ul className="divide-y divide-border/60 p-2">
                    {[
                      "Campaign scripts aligned before intake goes live.",
                      "Inbound leads with dispositions your closers can trust.",
                      "Reporting on response rate, conversion, and channel ROI.",
                    ].map((line) => (
                      <li
                        key={line}
      ...
      <section className="border-t border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
            Answering your direct response questions
          </h2>
          <div className="mt-3 h-1 w-12 rounded-full bg-primary" aria-hidden />
          <p className="mt-4 text-base leading-relaxed text-muted">
            Every call matters—Callify pairs professional handling with the convenience
            of a true inbound partner, not a script factory.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted">
            Clear scope, honest pricing, and agents who treat your buyers with respect—
            whether you are testing a pilot or scaling nationwide.
          </p>
      ...
      <section className="bg-gradient-to-b from-surface to-primary-soft/30 py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
            Your direct response program—from launch to optimization
          </h2>
          <div className="mt-3 h-1 w-12 rounded-full bg-primary" aria-hidden />
          <p className="mt-6 text-base leading-relaxed text-muted sm:text-lg">
            Dedicated campaign support across advertising, inbound customers, and
            overflow—at a fraction of building everything in-house.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Speed, client delight, and growth drive how we work—from shared customer
            commitment to a platform built for measurable response.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Modern direct response operations—lower cost per lead with efficiency
            that outdated call center models cannot match.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Advertising through personal interaction—launched and marketed the right
            way for your brand, not a generic template.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Highest-quality calls across voice channels—IVR, mobile, and digital—
            with ongoing tuning so reach and conversion keep improving.
          </p>

          <div className="mt-12 rounded-2xl border border-primary/20 bg-white p-6 shadow-sm">
            <p className="text-base font-semibold text-foreground">
              Ready to scope a direct response pilot?
            </p>
            <p className="mt-2 text-sm text-muted">
              Share your campaign, channels, and CRM—we will respond with a clear plan.
            </p>
