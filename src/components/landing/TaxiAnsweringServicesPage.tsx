...
const servicePillars = [
  {
    title: "Taxi dispatch agents",
    body: "24/7 ride requests handled while drivers stay focused on the road—not the phone.",
    icon: UsersIcon,
  },
  {
    title: "Premium booking support",
    body: "Qualified bookings with profiling and screening before jobs reach your fleet.",
    icon: CheckIcon,
  },
  {
    title: "Hotline cab booking",
    body: "Phone, email, chat, and text—one-on-one help without dropped dispatch calls.",
    icon: ClockIcon,
  },
  {
    title: "Inbound taxi services",
    body: "Calls, payments, and schedules captured in your systems—less back-office chaos.",
    icon: ClipboardIcon,
  },
  {
    title: "Reservation management",
    body: "Track reservations from booking through fulfillment with accurate rider data.",
    icon: ChartIcon,
  },
  {
    title: "Always available",
    body: "Never closed—live agents, no voicemail maze, every lead captured professionally.",
    icon: ValueIcon,
  },
];
...
const testimonials = [
  {
    quote:
      "Callify transferred our dispatch calls smoothly—volume up about 20%. Reliable partner I would recommend to other fleets.",
    name: "Ulric Green",
    role: "Owner, regional cab company",
  },
  {
    quote:
      "Tier-one support is courteous and always available—far exceeded what we expected from an outsourced desk.",
    name: "Belinda Madron",
    role: "Fleet operations manager",
  },
  {
    quote:
      "Quick, professional, never rude to riders—after twelve years in telecom, Callify stands out as great to work with.",
    name: "Alex Ramos",
...
const faqs = [
  {
    q: "Why choose Callify for taxi answering services?",
    a: "Quality assurance on every call—thorough documentation, scalable operations, and agents trained to stay calm under pressure.",
  },
  {
    q: "What are the benefits of inbound taxi call center service?",
    a: "Riders reach you easily when they need a ride—especially valuable as you grow or compete with rideshare apps.",
  },
  {
    q: "How do I get started with Callify?",
    a: "Contact us with the services you need—we align strategy, scripts, and launch steps in a consultation at your pace.",
  },
  {
    q: "Can Callify deliver inbound taxi call center service?",
    a: "Yes—we have provided voice programs for transportation teams with high-quality handling and clear reporting.",
  },
];
  ...
  return (
    <>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-14 lg:grid-cols-2 lg:gap-14 lg:py-20">
          <div className="min-w-0">
            ...
            <h1 className="mt-5 text-3xl font-bold tracking-tight text-foreground sm:text-4xl lg:text-[2.35rem] lg:leading-[1.12]">
              Taxi answering service
            </h1>
            <p className="mt-5 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
              Your best outsourcing partner for dispatch—answer every ride request with
              reliability riders remember.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-lg lg:mx-0 lg:max-w-none">
            ...
            <figure className="relative aspect-[5/4] overflow-hidden rounded-3xl border border-white/60 bg-white shadow-[0_28px_60px_-28px_rgba(65,116,185,0.35)] ring-1 ring-primary/10 sm:aspect-[4/3]">
              <Image
                src={HERO_IMAGE}
                alt="Taxi dispatch and customer service team"
                fill
                priority
      ...
      <section className="border-b border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
            Why choose Callify inbound taxi answering
          </h2>
          ...
          <p className="mt-6 text-base font-medium italic text-primary sm:text-lg">
            Stay ahead as rideshare competition grows—answer every call with reliable service.
          </p>
          <p className="mt-6 text-base leading-relaxed text-muted sm:text-lg">
            Callify taxi dispatch call center solutions help you deliver excellent customer
            service without drivers booking the next trip on the phone while driving.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            Representatives are available 24/7 for late-night rides or early flights—we
            reach drivers by text, email, or phone with the details they need.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            Call and caller data are recorded in a secure online portal for management—
            focus on daily operations while after-hours calls are handled professionally.
          </p>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-b from-surface via-white to-surface py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4">
          <div className="max-w-2xl">
            <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
              Inbound taxi call center services
            </h2>
            <div className="mt-3 h-1 w-12 rounded-full bg-primary" aria-hidden />
            <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
              Quality assurance on every call—human agents, no voicemail maze, and programs
              built for fleets that cannot afford to miss a booking.
            </p>
          </div>
      ...
      <section className="border-y border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4">
          <h2 className="text-center text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
            What clients say about our taxi answering team
          </h2>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-14 lg:items-start">
            <div className="lg:col-span-7">
              <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
                Tell us about your taxi answering needs
              </h2>
              <div className="mt-3 h-1 w-12 rounded-full bg-primary" aria-hidden />
              <p className="mt-4 max-w-lg text-base leading-relaxed text-muted">
                Complete the form and we will follow up with dispatch volume, coverage
                hours, and a launch plan for your fleet.
              </p>
              <form
                onSubmit={onSubmit}
              ...
              <div className="lg:sticky lg:top-28">
                <div className="overflow-hidden rounded-3xl border border-border/90 bg-white shadow-[0_20px_50px_-24px_rgba(15,23,42,0.15)] ring-1 ring-black/[0.04]">
                  ...
                  <ul className="divide-y divide-border/60 p-2">
                    {[
                      "Scripts and dispatch rules aligned before calls go live.",
                      "Driver handoff via phone, text, or email—your choice.",
                      "Reporting on volume, bookings, and call outcomes.",
                    ].map((line) => (
                      <li
                        key={line}
      ...
      <section className="border-t border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted">
            Inbound taxi programs with quality assurance—every call documented and
            scalable as your fleet grows.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted">
            Questions about coverage or pricing? Contact us anytime—we respond as soon as we can.
          </p>
      ...
      <section className="bg-gradient-to-b from-surface to-primary-soft/30 py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
            We&apos;re all about your taxi business
          </h2>
          <div className="mt-3 h-1 w-12 rounded-full bg-primary" aria-hidden />
          <p className="mt-6 text-base leading-relaxed text-muted sm:text-lg">
            Our mission: treat your taxi business like ours. Our promise: a solution that
            fits how you dispatch, bill, and serve riders.
          </p>

          <h3 className="mt-10 text-xl font-bold text-foreground">
            Expert taxi booking agents
          </h3>
          <p className="mt-3 text-base leading-relaxed text-muted">
            We handle calls, capture rider details, and route to the right driver or desk—
            so you focus on the road and the customer in the cab.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Agents trained on your scripts, service areas, and brand tone—outstanding
            service from day one of go-live.
          </p>

          <h3 className="mt-10 text-xl font-bold text-foreground">
            Transparency & call recording
          </h3>
          <p className="mt-3 text-base leading-relaxed text-muted">
            Monitor performance, time on calls, and daily volume—recordings and reporting
            so you never lose track of what was promised to riders.
          </p>

          <h3 className="mt-10 text-xl font-bold text-foreground">
            Modern dispatch-ready solutions
          </h3>
          <p className="mt-3 text-base leading-relaxed text-muted">
            Virtual reception, IVR, and 24/7/365 coverage—extend hours without adding
            on-site headcount and keep riders choosing your fleet over rideshare apps.
          </p>

          <div className="mt-12 rounded-2xl border border-primary/20 bg-white p-6 shadow-sm">
            <p className="text-base font-semibold text-foreground">
              Ready to scope a taxi answering pilot?
            </p>
            <p className="mt-2 text-sm text-muted">
              Share your fleet size, coverage hours, and tools—we will respond with a clear plan.
            </p>
