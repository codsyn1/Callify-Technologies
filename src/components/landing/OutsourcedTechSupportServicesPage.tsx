...
const servicePillars = [
  {
    title: "Tech support call agents",
    body: "Live help via phone, screen share, email, IM, and social—customers back to business fast.",
    icon: UsersIcon,
  },
  {
    title: "Remote access management",
    body: "Keep technology working flawlessly—monitored and maintained from anywhere.",
    icon: ChartIcon,
  },
  {
    title: "Help desk service",
    body: "Reach users directly, fix issues remotely, and cut hold-time friction for your team.",
    icon: ClipboardIcon,
  },
  {
    title: "Tech sales support",
    body: "Sales-aligned support at your fingertips—without hiring a full in-house rep bench.",
    icon: CheckIcon,
  },
  {
    title: "Query response service",
    body: "Dedicated triage to find root cause and resolve—not endless ticket ping-pong.",
    icon: HeartIcon,
  },
  {
    title: "Affordable 24/7 availability",
    body: "Enterprise-grade coverage at sensible tiers—support when users need it most.",
    icon: ValueIcon,
  },
];
...
const testimonials = [
  {
    ...
    name: "Gina Ogley",
    role: "IT director, SaaS",
  },
  {
    quote:
      "Years with Callify—calls, email, and social handled well, plus a dedicated manager when we need escalation.",
    name: "Lucy Moss",
    role: "Operations lead, software firm",
  },
  {
    quote:
      "Issues resolved within 24 hours—our customers stay happy. I recommend them for outsourced technical support.",
    name: "Oswald Malone",
    role: "Founder, hardware brand",
  },
];

const faqs = [
  {
    q: "What does Callify’s tech support call center include?",
    a: "Phone, chat, email, and social handling by trained agents—personalized help while you focus on core business work.",
  },
  {
    q: "Why outsource technical support?",
    a: "Outstanding customer experience without building a full in-house engineering and service bench—especially for growing teams.",
  },
  {
    q: "What makes Callify different?",
    a: "Broad technology training, fast fixes, long-term solutions, and a knowledge base that shortens resolution time.",
  },
  {
    q: "How do I know if we need outsourced tech support?",
    a: "If complaint volume is rising or resolution times slip, outsourcing is often more cost-effective than scaling internal staff alone.",
  },
];
...
export function OutsourcedTechSupportServicesPage() {
  const { sent, submitting, error, onSubmit } = useContactForm({
    source: "outsourced-tech-support",
    ...
    <>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-14 lg:grid-cols-2 lg:gap-14 lg:py-20">
          <div className="min-w-0">
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
              Personal-assistant-level technical support—Callify helps you keep customers
              confident while agents handle daily calls and chats.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-lg lg:mx-0 lg:max-w-none">
            ...
            <figure className="relative aspect-[5/4] overflow-hidden rounded-3xl border border-white/60 bg-white shadow-[0_28px_60px_-28px_rgba(65,116,185,0.35)] ring-1 ring-primary/10 sm:aspect-[4/3]">
              <Image
                src={HERO_IMAGE}
                alt="Technical support team assisting customers"
                fill
                priority
      ...
      <section className="border-b border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="mt-6 text-base leading-relaxed text-muted sm:text-lg">
            Callify manages queues and customer requests—live calls, chats, email, and
            social—so your team focuses on running the company.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            Professional, personable agents—clear transfers, time to gather details,
            and plans that match how you support customers today.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            Experts available 24/7 to resolve issues diligently—near-flawless satisfaction
            is the standard we aim for on every program.
          </p>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-b from-surface via-white to-surface py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
              Prestigious customer support—free your internal IT team for strategic projects
              while users get best-in-class help.
            </p>
          </div>
              ...
              <div className="lg:sticky lg:top-28">
                <div className="overflow-hidden rounded-3xl border border-border/90 bg-white shadow-[0_20px_50px_-24px_rgba(15,23,42,0.15)] ring-1 ring-black/[0.04]">
                  ...
                  <ul className="divide-y divide-border/60 p-2">
                    {[
                      "Runbooks and tiers aligned before support goes live.",
                      "Escalation paths your engineering team can trust.",
                      "Reporting on volume, handle time, and satisfaction.",
                    ].map((line) => (
                      <li
                        key={line}
      ...
      <section className="border-t border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted">
            Top-tier support without the overhead—scope, tiers, and channels explained
            before go-live.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted">
      ...
      <section className="bg-gradient-to-b from-surface to-primary-soft/30 py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-3 h-1 w-12 rounded-full bg-primary" aria-hidden />
          <p className="mt-6 text-base leading-relaxed text-muted sm:text-lg">
            Tailored programs—metrics on abandonment and handle time, data-driven
            improvement, and a culture of service excellence.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Support for leads from outbound campaigns and inbound queues—one partner for
            the full technical support stack.
          </p>
