...
const solutions = [
  {
    title: "Experienced support specialists",
    body: "Tier-1 and tier-2 agents trained on your stack, runbooks, and escalation matrix—ready for incidents big and small.",
    icon: UsersIcon,
  },
  {
    title: "Resolve IT issues faster",
    body: "Structured troubleshooting, knowledge-base discipline, and clean ticket notes so engineering is not re-asking the same questions.",
    icon: CpuIcon,
  },
  {
    title: "Improve customer loyalty",
    body: "Clear communication, empathy, and follow-through on every call, chat, or email—so users feel supported, not brushed off.",
    icon: HeartIcon,
  },
  {
    title: "Remote-ready delivery",
    body: "Distributed teams with secure access models and shift coverage that match how your product and users operate globally.",
    icon: GlobeIcon,
  },
  {
    title: "24/7 support for your business",
    body: "Nights, weekends, and release windows covered—because outages and login issues rarely happen on a 9–5 schedule.",
    icon: ClockIcon,
  },
  {
    title: "Reduce IT support costs",
    body: "Overflow and dedicated pods that scale with ticket volume—without expanding in-house headcount for every product launch.",
    icon: ValueIcon,
  },
];
...
const bpoPillars = [
  ...
  {
    title: "Data security",
    body: "Encryption, access controls, and clean-desk policies designed for IT vendor reviews, SOC-style questionnaires, and audit cycles.",
    icon: LockIcon,
  },
  {
  ...
  },
  {
    ...
    body: "Unit economics and forecasting your leadership can reconcile to ticket volume—not surprise true-ups.",
    icon: HeartIcon,
  },
  {
...
const testimonials = [
  ...
  },
  {
    ...
    name: "Riley Park",
    role: "Founder, managed services provider",
  },
  {
    quote:
    ...
    name: "Alex Kim",
    role: "VP operations, enterprise software",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "We use dual-tone QA, calibration with your leads, and dashboards on FCR, CSAT proxies, and backlog. Scope and SLAs are documented before go-live.",
  },
  {
    q: "Can you work with our business schedule?",
    a: "Yes. We model shifts, languages, and channels to your release calendar, user time zones, and peak windows—not a one-size-fits-all roster.",
  },
  {
    q: "What IT support scopes do you handle?",
    a: "Help desk, password and access issues, application troubleshooting, onboarding assist, status pages coordination, and tier-1 triage before engineering escalation.",
  },
  {
    q: "How do we know outsourcing is the right fit?",
    a: "If you want professional, tool-equipped agents; transparent economics; and a partner who documents work in your systems—not hidden fees or opaque handoffs—our discovery call will map a pilot.",
  },
];
...
export function IndustryITCallCenterPage() {
    ...
    <>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-14 lg:grid-cols-2 lg:gap-14 lg:py-20">
          <div className="min-w-0">
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
              Callify Technologies is your outsourcing partner for help desk,
              tech support, and multichannel IT service—so your engineers focus
              on building, not answering the same ticket twice.
            </p>
      ...
      <section className="border-b border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="mt-6 text-base font-medium italic text-primary sm:text-lg">
            Customizable IT support that accelerates resolution—and keeps users
            loyal.
          </p>
          <p className="mt-6 text-base leading-relaxed text-muted sm:text-lg">
            Think of an IT call center as an extension of your product team:
            trained agents, clear runbooks, and integrations with the tools you
            already use. Callify delivers voice, chat, and email with QA your
            engineering and operations leads can trust.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            Whether you are a startup shipping weekly or an enterprise managing
            global infrastructure, we align staffing, scripts, and reporting to
            your stack—not a generic script factory.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            Transparent processes help you reduce cost and distraction while
            improving customer engagement across every support channel.
          </p>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-b from-surface via-white to-surface py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
              Full-service IT support for SaaS, MSPs, and internal IT teams—with
              low-friction processes and clear handoffs to tier-2 and engineering.
            </p>
          </div>
              ...
              <div className="lg:sticky lg:top-28">
                <div className="overflow-hidden rounded-3xl border border-border/90 bg-white shadow-[0_20px_50px_-24px_rgba(15,23,42,0.15)] ring-1 ring-black/[0.04]">
                  ...
                  <ul className="divide-y divide-border/60 p-2">
                    {[
                      "Runbooks and escalation paths aligned to your stack.",
                      "QA rubrics your engineering and support leads can review.",
                      "Dashboards on tickets, FCR, and backlog—not vanity metrics.",
                    ].map((line) => (
                      <li
                        key={line}
      ...
      <section className="bg-gradient-to-b from-surface to-primary-soft/30 py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted">
            Callify combines technology and skilled people so you can streamline
            operations, reduce cost, and improve customer satisfaction. These
            answers cover how we partner with IT teams.
          </p>
      ...
      <section className="border-t border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-3 h-1 w-12 rounded-full bg-primary" aria-hidden />
          <p className="mt-6 text-base leading-relaxed text-muted sm:text-lg">
            We help businesses of every size—from local teams to enterprise IT—
            with support designed around your product, users, and tooling.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Operations keep running when applications or infrastructure hiccup.
            We document incidents, communicate status clearly, and escalate with
            context engineering can act on immediately.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Pay-as-you-go overflow, dedicated pods, or blended models—we match
            how you sell, ship, and support—not a rigid package you cannot grow
            out of.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            With governed access, secure processes, and 24/7 options, you can
            focus on roadmap work while users get consistent answers on voice,
            chat, and email.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Fast, knowledgeable support reduces churn and unlocks expansion.
            We align metrics to retention drivers your leadership already tracks.
          </p>
          ...
          <div className="mt-12 rounded-2xl border border-primary/20 bg-primary-soft/40 p-6">
            ...
            <p className="mt-2 text-sm text-muted">
              Share your stack, ticket volume, and channels—we will respond with
              a clear plan.
            </p>
