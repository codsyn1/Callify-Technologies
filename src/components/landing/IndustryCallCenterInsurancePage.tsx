...
const servicePillars = [
  {
    title: "Comprehensive coverage alignment",
    body: "We map queues, disclosures, and verification steps so agents follow carrier and state-sensitive rules consistently.",
    icon: ShieldIcon,
  },
  {
    title: "Claims intake & documentation",
    body: "Structured data capture, clean handoffs, and disposition discipline reduce rework and speed downstream processing.",
    icon: ClipboardIcon,
  },
  {
    title: "Licensed-expert coordination",
    body: "Complex questions route to the right tier; generalists handle policy servicing with clear escalation paths.",
    icon: UsersIcon,
  },
  {
    title: "Policyholder retention programs",
    body: "Outbound wellness touches, renewal reminders, and proactive outreach—always respectful of consent and quiet hours.",
    icon: HeartIcon,
  },
  {
    title: "Custom quotes & eligibility support",
    body: "Scripted yet flexible talk tracks help prospects compare options without overpromising or skipping required language.",
    icon: ChartIcon,
  },
  {
    title: "24/7 customer support",
    body: "Follow-the-sun coverage for claims spikes, weather events, and seasonal enrollment peaks with real-time QA.",
    icon: ClockIcon,
  },
];
...
const testimonials = [
  {
    ...
    name: "Jordan Ellis",
    role: "Operations director, regional MGA",
  },
  {
    quote:
...
const faqs = [
  {
    q: "What insurance programs do you typically support?",
    a: "Property & casualty servicing, health and benefits enrollment support, life policy servicing, and producer-assisted intake—scoped to your carrier scripts and compliance pack.",
  },
  {
    q: "What outcomes should we expect in the first 90 days?",
    a: "Stabilized handle times, cleaner dispositions, fewer repeat contacts, and a QA trajectory you can present to internal audit or carrier partners.",
  },
  {
    q: "Why outsource insurance contact center work instead of only hiring?",
    a: "You gain surge capacity, bilingual coverage, and a management layer that already knows regulated workflows—without delaying your roadmap while you recruit.",
  },
  {
    q: "How is pricing structured?",
    a: "Most programs blend per-interaction and dedicated FTE models so you are not overpaying during quiet weeks or understaffed during storms or enrollment.",
  },
  {
    q: "Do you offer more than voice?",
    a: "Yes—email, chat, and secure document workflows can sit beside voice with unified QA and reporting.",
  },
];
...
export function IndustryCallCenterInsurancePage() {
  const { sent, submitting, error, onSubmit } = useContactForm({
    source: "industry-call-center-insurance",
    ...
    <>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-14 lg:grid-cols-2 lg:gap-14 lg:py-20">
          <div className="min-w-0">
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
              Callify Technologies helps carriers, MGAs, and brokers deliver
              dependable voice, chat, and email support—without sacrificing the
              controls your regulators and partners expect.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-lg lg:mx-0 lg:max-w-none">
            ...
            <figure className="relative aspect-[5/4] overflow-hidden rounded-3xl border border-white/60 bg-white shadow-[0_28px_60px_-28px_rgba(65,116,185,0.35)] ring-1 ring-primary/10 sm:aspect-[4/3]">
              <Image
                src={HERO_IMAGE}
                alt="Insurance professionals reviewing policy documents"
                fill
                priority
      ...
      <section className="border-b border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
            Protecting your business with disciplined insurance contact center
            delivery
          </h2>
          <div className="mt-4 h-1 w-12 rounded-full bg-primary" aria-hidden />
          <p className="mt-6 text-base leading-relaxed text-muted sm:text-lg">
            Insurance buyers expect clarity on coverage, fast answers on claims,
            and respectful follow-up on renewals. Your brand cannot afford vague
            scripts or inconsistent verification.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            Callify builds programs with documented workflows, dual-tone QA,
            and transparent reporting so you always know what changed—and why.
            Whether you need overflow for enrollment, dedicated policy service,
            or producer support, we align to your playbook.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            From FNOL intake to billing inquiries, we keep teams calibrated to
            your carrier guidelines while freeing your internal staff for
            exceptions, escalations, and growth initiatives.
          </p>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-b from-surface via-white to-surface py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
              Six pillars we deploy on day one—then tune weekly with your QA and
              compliance partners.
            </p>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-14 lg:items-start">
            <div className="lg:col-span-7">
              ...
              <p className="mt-4 max-w-lg text-base leading-relaxed text-muted">
                Complete the form and we will follow up with next steps—scope,
                compliance needs, and a realistic pilot plan.
              </p>
              <form
                onSubmit={onSubmit}
              ...
              <div className="lg:sticky lg:top-28">
                <div className="overflow-hidden rounded-3xl border border-border/90 bg-white shadow-[0_20px_50px_-24px_rgba(15,23,42,0.15)] ring-1 ring-black/[0.04]">
                  ...
                  <ul className="divide-y divide-border/60 p-2">
                    {[
                      "Carrier-ready QA rubrics and weekly calibration.",
                      "Security and privacy posture aligned to your vendor review.",
                      "Transparent reporting on SLAs, quality, and backlog.",
                    ].map((line) => (
                      <li
                        key={line}
      ...
      <section className="border-t border-border bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted">
            Insurance is a trust business. These answers explain how Callify
            approaches governance, staffing, and continuous improvement.
          </p>
      ...
      <section className="bg-gradient-to-b from-surface to-primary-soft/30 py-14 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-3 h-1 w-12 rounded-full bg-primary" aria-hidden />
          <p className="mt-6 text-base leading-relaxed text-muted sm:text-lg">
            Spikes happen—storms, regulatory changes, enrollment windows. If your
            contact center cannot flex, customers churn and producers lose
            confidence. A disciplined partner absorbs volume while keeping every
            utterance inside approved boundaries.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            You get a single accountable lead who owns staffing forecasts,
            calibration agendas, and change logs. No more guessing which vendor
            manager owns your account during a severity-1 spike.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Renewal reminders, wellness nudges, and proactive outreach are
            choreographed with consent, frequency caps, and opt-down paths—so
            outreach feels helpful, not noisy.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            We review existing scripts, carrier addenda, and CRM fields to find
            gaps before agents take their first live call. Findings become a
            punch-list tracked to closure with your compliance team.
          </p>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Shared, dedicated, and hybrid pods are modeled against your volume
            curves. You pick the economics and risk profile that match your
          ...
          <p className="mt-3 text-base leading-relaxed text-muted">
            Real-time dashboards, post-interaction surveys, and closed-loop
            coaching mean leadership always sees the same truth your QA team
            does. When something drifts, we fix the root cause—not just the
            symptom.
          </p>
          ...
          <div className="mt-12 rounded-2xl border border-primary/20 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm text-muted">
              Share your lines of business, channels, and compliance pack—we
